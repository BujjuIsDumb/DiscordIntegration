...
namespace DiscordIntegration.Rpc.SdkWrapper
{
    ...
    internal partial struct Activity
    {
        ...
        public RichPresence ToRichPresence()
        {
            return new RichPresence()
            {
                ...
                Timestamp =
                {
                    Start = DateTimeOffset.FromUnixTimeSeconds(Timestamps.Start).DateTime,
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    internal partial struct ImeUnderline
    {
        public int From;
    ...
    internal partial class Discord : IDisposable
    {
        ...
        private static partial Result DiscordCreate(uint version, ref FFICreateParams createParams, out IntPtr manager);
        ...
        private void InitEvents(IntPtr eventsPtr, ref FFIEvents events) => Marshal.StructureToPtr(events, eventsPtr, false);
    ...
    internal partial class OverlayManager
    {
        ...
        public void ForwardMessage(IntPtr message) => Methods.ForwardMessage(MethodsPtr, message);
